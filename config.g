...
; Heaters
M307 H0 A125.0 C140.2 D0.3 S1.00 V24.0 B0 ; Disable bang-bang mode for the bed heater and set PWM limit
M307 H1 A426.6 C148.6 D4.8 S1.00 V24.0 B0 ; Disable bang-bang mode for the nozzle heater and set PWM limit
