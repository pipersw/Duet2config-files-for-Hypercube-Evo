...
M671 X-25:325 Y150:150 S2.0 F1.2		 ; leadscrews at left (connected to Z) and right (connected to E1) of X axis
M350 X16 Y16 Z16 E16 I1                  ; Configure microstepping with interpolation
M92 X160 Y160 Z400 E830                    ; Set steps per mm with 1/16 and BMG extruder with 0.9° stepper on XY, 1.8° on Z, leadscrew pas 8mm
M566 X600 Y600 Z15 E120                 ; jerk, Set maximum instantaneous speed changes (mm/min)
M203 X15000 Y15000 Z125 E2100            ; Set maximum speeds (mm/min)
M201 X1000 Y1000 Z20 E360                ; Set accelerations (mm/s^2)
M204 P5000 T4000                         ; Set Max acceleration for P=printing moves and T=travel move
M906 X1000 Y1000 Z1400 E800 I30          ; Set motor currents (mA) and motor idle factor
...
M558 P9 F120 H2.5 R0.5 T6000 A10 S0.005 B1  ; Set Z probe type to bltouch and the dive height + speeds
G31 P25 X0 Y80 Z1.10                     ; Set Z probe trigger value, offset and trigger height
M557 X10:290 Y80:290 P5			 ; Set Z probe point or define probing grid
...
; Max temp Protection
M143 H0 S140                                 ; Set temperature limit for heater 0 bed to 140C
M143 H1 S285                                 ; Set temperature limit for heater 1 hotend to 285C
...
; Fans
M106 P0 S0 I0 F100 H-1 C"Tool_Fan"                ; Set fan 0 value, PWM signal inversion and frequency. Thermostatic control is turned off
...
M106 P2 H100:101:102 F500 L0.0 X0.05 B0.5 T50:70 C"Duet_Fan"        ; set fan 2 value, turn on at 50% if the CPU temperature reaches 55C, and increase to full speed gradually as the temperature rises to 70C
