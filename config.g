...
M203 X12000 Y12000 Z200 E1200            ; Set maximum speeds (mm/min)
M201 X1500 Y1500 Z300 E360               ; Set accelerations (mm/s^2)
...
M558 P9 C"zprobe.in+zprobe.mod" F150 H5 R0.5 T3000 A10 S0.03 B0  ; set Z probe type to bltouch and the dive height + speeds
...
M307 H1 H1 A771.7 C282.9 D6.2 S1.00 V24.0 B0      ; Disable bang-bang mode for the nozzle heater and set PWM limit
...
M106 P1 H1:3 T45                               ; Set fan 1/pump value, turned on if hotend or water reaches 45C
...
M911 S19.0 R21.0 P"M913 X0 Y0 G91 M83 G1 Z3 E-5 F1000"
