...
M98 P"config_perso.g"                    ; call specific settings
;M98 P"config_dupehart.g"                    ; call specific settings
...
;M591 D0 P2 C"zstop" S1                         ; sensor for extruder 0, simple sensor (low signal when filament present) on Z endstop
...
G31 P25 X0 Y80 Z2.10                                             ; Set Z probe trigger value, offset and trigger height
M557 X0:300 Y80:310 P20			                                 ; Set Z probe point or define probing grid 15 points per axis
...
M106 P1 S1.0 H-1 C"Pump"                       ; Set fan 1/pump value. Thermostatic control is turned off
...
; Bed temperature
M140 S0 R0                              ; Set initial bed active and standby temperatures to 0C
